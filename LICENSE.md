                    The Based License v1.3.4

Used by <holder> on <day month year>
...
can obtain a copy from https://github.com/ThatOneCalculator/BASED-LICENSE/blob/main/LICENSE .
...
This software is provided with no waranty. If the device you're running this on gets messed up because of
this software, that's on you reading this for not auditing the code before running this software.

If this software has network connectivity (i.e. connecting to the internet) this software must have any first party
backend, first party frontend, and any first party middleware (API layer) must be licensed under the based license.
This excludes any external (third party) service accessed through your service through the user's own direct actions.
...
If this software depends on other software dependenccies under different licenses, the parts that are used under
...
software this copy of the based license is being used for have the right to persue legal action against you if
